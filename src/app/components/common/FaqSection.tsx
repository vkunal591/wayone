        ...
        <section id="faq" className="py-20 ">
            <div className="container mx-auto">
                ...
                <div className="space-y-4 mx-auto" data-aos="fade-up" data-aos-delay="100">
                    {faqs.map((faq, index) => (
                        ...
                        >
                            ...
                            <div
                                className={`px-6 text-gray-600 text-sm overflow-hidden transition-all duration-500 ease-in-out ${openIndex === index ? "max-h-40 pb-4" : "max-h-0"
                                    }`}
                            >
                                <div>{faq.answer}</div>
                            </div>
                ...
                <div
                    ...
                    data-aos-delay="200"
                >
                    <h3 className="text-xl text-center font-semibold">Let's Build Something Amazing Together!</h3>

                    <Link
                        href="/contact-us"
                        className="mt-4 md:mt-0 bg-white text-primary font-semibold px-6 py-2 rounded-xl shadow hover:bg-gray-100 transition"
                    >
                        Contact Now
                    </Link>
                    <Image
