      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className={`feature-box p-6 rounded-lg shadow-lg transition-all duration-300 hover:scale-105 ${feature.bgColor}`}
              data-aos="zoom-in"
            ...
            >
              ...
              <button className="mt-4 px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary">
                {feature.buttonText}
              </button>
            </div>
          ))}
