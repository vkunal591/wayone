    ...
    return (
        <div className="max-w-7xl !pt-24 mx-auto bg-white">
            <div className="max-w-7xl m-auto px-4 lg:px-16 bg-white">
                <HeroSection title1={"Smart Solutions for  "} title2={" Manufacturing & Industrial Innovation"} description={"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."} />
                <WhoWeAre
                    imageSrc="/assets/images/industry/industry.png"
                    imageAlt="About WayOne"
                    heading="Who We Are"
                    subheading="Innovating Manufacturing & Industry"
                    highlightedText=""
                    paragraphs={[
