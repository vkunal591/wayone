    ...
    return (
        <div className="max-w-7xl !pt-24 mx-auto bg-white">
            <div className="max-w-7xl m-auto px-4 lg:px-16 bg-white">
                <HeroSection title1={"Driving the Future with Cutting-Edge  "} title2={"Technology & Innovation"} description={"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."} />
                <WhoWeAre
                    imageSrc="/assets/images/industry/tech.png"
                    imageAlt="About WayOne"
                    heading="Who We Are"
                    subheading="Driving the Future with Cutting-Edge Technology & Innovation"
                    highlightedText=""
                    paragraphs={[
