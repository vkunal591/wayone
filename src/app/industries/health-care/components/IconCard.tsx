                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
                    {steps.map((step, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="rounded-4xl mb-4 flex-1 border border-gray-50 bg-gray-100 pb-8"
                            ...
                            >
                                <div className="flex flex-row items-start gap-4 p-8">
                                    <div className="text-center">
                                        <div className="text-primary text-5xl mb-4 w-20 h-20 rounded-full p-4 m-auto bg-white">
                                            <Icon />
                                        </div>
