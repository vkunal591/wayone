                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        ...
                        <div className="w-full lg:w-7/12">
                            <div className="contact-form space-y-6">
                                <h2 className="text-3xl md:text-4xl font-bold">Connect With Us Today</h2>
                                <p className="text-gray-700">
                                    Ready to turn your ideas into reality? Contact us for expert solutions and customized services that
                                    go above and beyond.
                                </p>
