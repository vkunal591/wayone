    ...
    return (
      <section className="partner-with-us py-16 bg-white">
        <div className="max-w-4xl mx-auto text-center mb-12">
          <h2 className="text-3xl md:text-4xl text-gray-800 font-medium mb-6">Why Partner with Us?</h2>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-100 rounded-lg shadow-md p-6 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-2">Efficient Project Management</h3>
            ...
            <div className="bg-gray-100 rounded-lg shadow-md p-6 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-2">Expert Team at Your Service</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-100 rounded-lg shadow-md p-6 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-medium text-gray-800 mb-2">Timely Project Completion</h3>
              <p className="text-gray-600">
