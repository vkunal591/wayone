        ...
        <section id="ui-ux-process" className="py-4 lg:py-16">
            <div className="container mx-auto ">
                <div className="text-start" data-aos="fade-up">
                    <h6 className="text-primary text-lg font-medium">{subtitle}</h6>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-8 flex-wrap justify-center">
                    {steps.map((step) => (
                        <div
                            key={step.number}
                            className="p-4 mb-4 rounded-xl border-2 border-color-primary w-full "
                            data-aos="fade-up"
                            data-aos-delay={`${step.delay}`}
                        >
                            <div className="flex flex-col p-4">
                                <div className="font-medium text-primary text-xl mb-2">{`0${step.number}. ${step.title}`}</div>
