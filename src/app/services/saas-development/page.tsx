...
const dynamicData = {
    ...
    shortDesc: "Custom SaaS solutions that are made for growth, scalability, and smooth operation.",
    description: "We offer top-performance SaaS applications that grow with your business with innovative technology solutions that are secure, reliable, and scalable to meet your evolving needs.",
...
const steps = [
    {
        ...
        description: 'Understanding your business needs and setting clear objectives for the SaaS product.',
        iconClass: 'bi-hospital',
        delay: 100,
    },
    {
        title: 'Design and  Prototyping',
        description: 'Crafting wireframes and prototypes to visualize functionality and ensure design alignment.',
        iconClass: 'bi-hospital',
        delay: 200,
    },
    {
        title: 'Development',
        description: 'Delivering secure, scalable, and user-focused digital product solutions',
        iconClass: 'bi-hospital',
        delay: 300,
    },
    {
        title: 'Testing and Assurance',
        description: 'Ensuring smooth performance with end-to-end quality assurance processes',
        iconClass: 'bi-hospital',
        delay: 400,
    },
];
