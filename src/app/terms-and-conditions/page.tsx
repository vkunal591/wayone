...
export default function Page() {
    return (
        <div className='mt-[6rem] max-w-7xl m-auto p-4 lg:p-16 lg:pt-0'>
            <Head>
                <title>Terms and Conditions | WayOne</title>
                <meta name="description" content="Read the Terms and Conditions for using WayOne services." />
            </Head>
            <main className="max-w-7xl mx-auto px-4 py-10 text-gray-800">
                ...
                <ul className="list-disc list-inside space-y-2 mb-4">
                    ...
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to WayOne.</li>
                ...
                <h2 className="text-2xl font-medium mt-8 mb-4">Acknowledgment</h2>
                <p className="mb-4">
                ...
                {/* For brevity, the rest of the content is abbreviated in structure below. You should paste the entire legal text provided for each section in full. */}
                <h2 className="text-2xl font-medium mt-8 mb-4">Links to Other Websites</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-medium mt-8 mb-4">Termination</h2>
                ...
                <h2 className="text-2xl font-medium mt-8 mb-4">Limitation of Liability</h2>
                ...
                <h2 className="text-2xl font-medium mt-8 mb-4">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
                <p className="mb-4">
                ...
                <h2 className="text-2xl font-medium mt-8 mb-4">Disputes Resolution</h2>
                <p className="mb-4">
                    If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
                </p>

                <h2 className="text-2xl font-medium mt-8 mb-4">For European Union (EU) Users</h2>
                <p className="mb-4">
                    If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.
                </p>

                <h2 className="text-2xl font-medium mt-8 mb-4">United States Legal Compliance</h2>
                <p className="mb-4">
                    You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.
                </p>

                <h2 className="text-2xl font-medium mt-8 mb-4">Severability and Waiver</h2>
                ...
                <h2 className="text-2xl font-medium mt-8 mb-4">Translation Interpretation</h2>
                <p className="mb-4">These Terms and Conditions may have been translated if We have made them available...</p>

                <h2 className="text-2xl font-medium mt-8 mb-4">Changes to These Terms and Conditions</h2>
